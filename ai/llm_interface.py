...
class ViralIntelligence:
    ...
    def _score_hook(self, text: str) -> float:
        ...
        hook_words = [
            "wait", "listen", "actually", "really", "truth",
            "shocking", "secret", "believe", "never", "always",
            "here's", "actually", "surprising", "unexpected",
            "reveal", "answer", "question", "why", "how"
        ]
    ...
    def _score_emotion(self, text: str) -> float:
        ...
        emotion_words = {
            "high": ["!", "amazing", "incredible", "love", "excited", "brilliant", "fantastic"],
    ...
    def _score_controversy(self, text: str) -> float:
        ...
        controversy_words = [
            "wrong", "mistake", "lie", "fake", "scam",
            "actually", "really", "belief", "disagree",
            "controversial", "debate", "argument"
        ]
    ...
    def rank_clips(self, clips: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for clip in clips:
            ...
            scored_clips.append({
                **clip,
                "viral_scores": scores,
                "rank_score": scores["overall_score"]
            })
